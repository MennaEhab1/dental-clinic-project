...
// export function AIChatWidget({ disease }: AIChatWidgetProps) {
//   const [isOpen, setIsOpen] = useState(false); // ❌ مش هيفتح تلقائي
...
//     try {
//       const response = await sendChatMessage(disease, text); // ✅ أهم تعديل
//       setMessages(prev => [...prev, response]);
//     } catch {
//       setMessages(prev => [
//         ...prev,
