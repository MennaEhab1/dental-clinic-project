                    ...
                    return (
                      <Card
                        ...
                        className={`relative cursor-pointer transition-all duration-200 ${
                          isSelected
                            ? "border-2 border-primary bg-primary/5 shadow-card ring-2 ring-primary/25"
                            : "border border-border hover:border-primary/40 hover:shadow-soft"
                        }`}
                        onClick={() =>
                          setBooking((prev) => ({
                            ...prev,
              ...
              {currentStep === "doctor" && (
                <div>
                  {filteredDoctors.length === 0 ? (
                    ...
                    <div className="grid md:grid-cols-2 gap-4">
                      {filteredDoctors.map((doctor) => {
                        const isSelected = booking.doctorId === doctor.id;
                        return (
                          <Card
                            key={doctor.id}
                            className={`relative cursor-pointer transition-all duration-200 ${
                            ...
                            availableSlots.map((slot) => {
                              ...
                              return (
                                <Button
                                  ...
                                  className={
                                    isSelected
                                      ? "gradient-bg border-0 ring-2 ring-primary/40 ring-offset-1 shadow-md"
